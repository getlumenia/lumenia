...
> **Status (2026-07-22): SHIPPED in code** — password + email-OTP recovery + a WebAuthn-PRF "Face ID" upgrade (recovery crypto self-test 18/18; multi-account keystore + sweep also shipped). Real-device PRF (Spike #2) + Resend domain verification still gate real users.
